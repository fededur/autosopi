...
source(file.path(project_root, "R", "02_config.R"))
source(file.path(project_root, "R", "03_data_sources.R"))
source(file.path(project_root, "R", "04_outputs.R"))
source(file.path(project_root, "R", "05_runner.R"))
